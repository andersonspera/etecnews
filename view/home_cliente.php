            ...
            <div class="col-sm-9">
                ...
                <div class="row">
                    ...
                    foreach($dadosNoticia as $value)
                    {
                        echo "<div class='col-12'>
                            <div class='card mb-3'>
                                <img src='".URL."recursos/imagens/$value->imagem' class='card-img-top' alt='...'>
                                <div class='card-body'>
                                    <h5 class='card-title'>$value->titulo</h5>
                                    <p class='card-text'>". substr($value->conteudo, 0, 150) . "...</p>
                                    <p class='card-text'><small class='text-muted'>Data da notícia: ". date("d/m/Y", strtotime($value->data)) . "</small></p>
                                    <a href='".URL."noticia/$value->codnoticia' class='btn btn-danger'><i class='fa fa-eye'></i> Ver mais...</a>
                                </div>
                            </div>
                        </div>";
                    }
